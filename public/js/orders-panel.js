function OrdersPanelComponent(bar, active, shipped, normal, info) {
  this.bar = bar.bag;
...
OrdersPanelComponent.annotations = [
  new angular.ComponentAnnotation({
    selector: 'orders-panel',
    appInjector: [FilterBar, FilterActive, FilterShipped, FilterNormal, PanelInfo]
  }),
  new angular.ViewAnnotation({
    templateUrl: '../tp/orders-panel.html',
    directives: [angular.NgFor, angular.NgIf, ServerStatusComponent]
  })
];

OrdersPanelComponent.parameters = [
  [FilterBar], [FilterActive], [FilterShipped], [FilterNormal], [PanelInfo]
];
...
OrdersPanelComponent.prototype.onSelectFilter = function (filter) {
...
OrdersPanelComponent.prototype.onBarKeyUp = function ($event) {
  this.bar.init = true;
...
OrdersPanelComponent.prototype.onActiveMouseUp = function (button) {
  this.active.button = button;
}

OrdersPanelComponent.prototype.onShippedMouseUp = function (button) {
  this.shipped.button = button;
}

OrdersPanelComponent.prototype.onNormalMouseUp = function (button) {
  this.normal.button = button;
}

OrdersPanelComponent.prototype.onSearchMouseUp = function () {
